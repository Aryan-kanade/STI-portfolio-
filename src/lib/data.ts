...
export const HERO = {
  eyebrow: "// Full-Stack Engineer · Kolhapur, Maharashtra",
  name: "Omkar Patil",
  headline: [
    "I turn manual operations into",
    "reliable digital systems",
  ] as [string, string],
  sub: "Founder-led software engineering for growing businesses and industrial sectors — custom software, mobile apps, AI automation and IoT, built to keep working as you scale.",
...
export const PROJECTS = [
  {
    ...
    approach:
      "I designed a role-based architecture that ingests live sensor data, normalises it, and serves it per role — operators see the floor view, management sees the trend view.",
    solution:
  ...
  },
  {
    ...
    approach:
      "I modelled the shared entities first (orders, people, jobs), then built each surface against that single model so an update in one place landed everywhere automatically.",
    solution:
  ...
  },
  {
    ...
    approach:
      "I built a mobile-first flow around the technician's day — assignment, evidence capture (photos, location), and live status — so the field is the source of truth, not a report.",
    solution:
...
export const METHODOLOGY = {
  ...
  pitch: "A loop, not a handover — every system I ship stays mine to support.",
  steps: [
    {
      num: "01",
      key: "strategy",
    ...
    },
    {
      ...
      key: "support",
      title: "Support",
      desc: "Long-term ownership. Your system keeps working — I stay behind it.",
    },
  ],
}
...
export const PRINCIPLES = [
  ...
  },
  {
    ...
    body: "A system isn't done at launch. I keep monitoring, fixing and improving it for as long as it runs.",
  },
]
...
export const FOUNDER = {
  ...
  highlights: [
    { title: "Full-stack ownership", body: "From data model to deployed UI — one engineer across the whole system, not a chain of handoffs." },
    ...
    { title: "Remote-first delivery", body: "Regular working increments over long silences — you see real progress, not a surprise at the end." },
  ],
}
...
export const FAQ = [
  {
    ...
    a: "It depends on scope — an MVP web app is usually weeks, a full platform is months. I scope honestly, quote in writing, and build in working increments you can see.",
  },
  {
    q: "How do we get started?",
    a: "A short discovery call or WhatsApp message. I ask about the operation you're running and the outcome you want, then come back with a written scope and a clear yes or no.",
  },
  {
    q: "How do you handle support after launch?",
    a: "I stay on. Every system I build ships with a support arrangement — monitoring, fixes and incremental improvements — not a goodbye at handover.",
  },
  {
    q: "Do you work with businesses outside Kolhapur and Maharashtra?",
    a: "Yes. I work with clients across India and internationally. Most delivery happens remotely with regular video reviews; on-site visits are available when needed.",
  },
  {
