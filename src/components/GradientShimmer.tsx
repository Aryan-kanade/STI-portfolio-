...
/** Project brand gradient — amber → accent → copper (matches .grad-text CSS). */
export const BRAND_GRADIENT: GradientStop[] = [
  { color: "var(--color-amber)", position: 0 },
  { color: "var(--color-accent)", position: 0.55 },
  { color: "var(--color-copper)", position: 1 },
]
